...
<body>
  <div class="container">
    ...
    <tr>
      ...
      <td style="width: 62.8655%; border: none rgb(0, 0, 0);"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">{{ $students['nis'] }}</span></td>
    </tr>
    <tr>
      ...
      <td style="width: 7.6505%; border: none rgb(0, 0, 0);"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">:</span></td>
      <td style="width: 62.8655%; border: none rgb(0, 0, 0);"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">{{ $students['name'] }}</span></td>
    </tr>
    <tr>
      ...
      <td style="width: 7.6505%; border: none rgb(0, 0, 0);"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">:</span></td>
      <td style="width: 62.8655%; border: none rgb(0, 0, 0);"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">{{ $students['rombel']['rombel'] }}</span></td>
    </tr>
    <tr>
      ...
      <td style="width: 7.6505%; border: none rgb(0, 0, 0);"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">:&nbsp;</span></td>
      <td style="width: 62.8655%; border: none rgb(0, 0, 0);"><span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">{{ $students['rayon']['rayon'] }}</span></td>
    </tr>
    </tbody>
    </table>
    <p><br></p>
    ...
    <table style="width: 100%; border-collapse: collapse; border: none rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif; font-size: 14px;">
      <tbody>
        ...
        <tr>
          <td style="width: 33.3333%; border: none rgb(0, 0, 0); text-align: center;"><br><br><br><br><br><br><br>({{ $students['name'] }})</td>
          <td style="width: 33.3333%; border: none rgb(0, 0, 0);"><br></td>
        ...
        <tr>
          <td style="width: 33.3333%; border: none rgb(0, 0, 0); text-align: center;"><br><br><br><br><br><br><br>({{ $students['rayon']['user_id'] }})<br></td>
          <td style="width: 33.3333%; border: none rgb(0, 0, 0);"><br></td>
